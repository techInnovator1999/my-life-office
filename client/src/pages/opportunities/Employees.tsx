  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-text-main dark:text-white">Employees</h1>
          <p className="text-xs text-gray-700 dark:text-gray-300 mt-0.5">
            Manage employee opportunities
          </p>
        </div>
      ...
      <div className="bg-white dark:bg-surface-dark rounded-lg shadow-sm border border-neutral-200 dark:border-slate-700 p-6">
        <p className="text-gray-700 dark:text-gray-300">Employees page coming soon...</p>
      </div>
    </div>
  )
}
